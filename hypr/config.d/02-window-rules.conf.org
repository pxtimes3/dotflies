...
windowrule = move 25% 25%,^(firefox)$
windowrule = size 50% 50%,^(firefox)$

windowrule = workspace 3 silent,^(discord)$
windowrule = move 50% 25%,^(discord)$
windowrule = size 45% 50%,^(discord)$

windowrule = workspace 3 silent,^(plexamp)$
windowrule = move 5% 75%,^(plexamp)$

windowrule = workspace 3 silent,^(telegram-desktop)$
windowrule = move 75% 75%,^(telegram-desktop)$

# Stack specific windows
